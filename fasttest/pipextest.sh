...
cd $PIPEXPATH && ./pipex ../pipexfasttest/infile "wc -w" "ls -a" 
echo -------------------------------------

echo
echo Error 2: Wrong keys
cd $PIPEXPATH && ./pipex ../pipexfasttest/infile "" "ls -abdsnj" $OUTPATH/out6
cat $OUTPATH/out6
echo -------------------------------------

echo
echo Error 3: Wrong input file
cd $PIPEXPATH && ./pipex ../pipexfasttest/ouc "grep -v ouch" "ls -a" $OUTPATH/out7
echo -------------------------------------

echo
echo Error 4: Wrong command
cd $PIPEXPATH && ./pipex ../pipexfasttest/infile "weewee" "wc -w" $OUTPATH/out6
echo -------------------------------------
